...
echo "CREATE USER '$project_name'@'10.5.0.6' IDENTIFIED BY '$django_db_pwd';">>./db/init.sql
echo "GRANT ALL PRIVILEGES ON $project_name.* TO '$project_name'@'10.5.0.6' WITH GRANT OPTION;">>./db/init.sql
